...
function drawUI() {
  ...
  items.forEach(function (item) {
    ...
    tmp.innerHTML = tmp.innerHTML + "<div class=\"column-24 first-column line-item\">" + "<div class=\"column-1 text-right pre-3\">" + "<a onclick=\"cart.destroyItem(" + id + ");\">x </a>" + "</div>" + "<div class=\"column-9\">" + "<span>" + item.title + "</span>" + "</div>" + "<div class=\"column-1 text-center\">" + "<a onclick=\"cart.removeItem(" + id + ");\"> - </a>" + "</div>" + "<div class=\"column-1 text-center\">" + "<span>" + item.quantity + "</span>" + "</div>" + "<div class=\"column-1 text-center\">" + "<a onclick=\"cart.addItem(" + title + ", " + id + ", " + item.price + ", 1);\"> + </a>" + "</div>" + "<div class=\"column-2 pre-1\">" + "<span>$</span>" + "<span class=\"right\">" + item.price + "</span>" + "</div>" + "<div class=\"column-2 pre-1\">" + "<span>$</span>" + "<span class=\"right\">" + item.quantity * item.price + "</span>" + "</div>" + "</div>";
  });
...
onclick = "cart.addItem('{{item.title}}', '{{item.id}}', {{item.price}}, 1);";
...
var tinyui = document.getElementsByClassName("tinycart")[0];
if (tinyui) {
  console.log("daraw plz");
  drawUI();
  listenUI();
}
